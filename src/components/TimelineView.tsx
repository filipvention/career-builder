                ...
                {yearNotes.map((note, index) => {
                  ...
                  return (
                    <div key={note.id} className="relative flex space-x-6">
                      {/* Timeline dot */}
                      <div className={`relative z-10 flex items-center justify-center w-12 h-12 rounded-full border-4 border-white shadow-lg ${getTypeColors(note.type)}`}>
                            ...
                            <div className="px-6 pb-6 space-y-6 border-t border-gray-100">
                              ...
                              {note.is_ai_processing ? (
                                ...
                                <div className="space-y-3">
                                  ...
                                  <p className="text-gray-800 bg-blue-50 p-4 rounded-lg border-l-4 border-blue-400 leading-relaxed font-medium">
                                    {note.ai_enhanced_description}
                                  </p>
                                </div>
                              ) : null}
