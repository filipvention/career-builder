        ...
        <div className="p-6 space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Choose how you want AI to enhance your career notes. This tone will be applied consistently across all AI generations including CV sections, LinkedIn posts, and promotion cases.
            </p>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <ul className="text-sm text-gray-700 space-y-1">
                  ...
                  <li>• <strong>Exports:</strong> CV sections, LinkedIn posts, and promotion cases will reflect your tone preference</li>
                  <li>• <strong>Existing Notes:</strong> Already enhanced notes will keep their current tone (you can regenerate them by editing)</li>
                </ul>
              </div>
            </div>
          </div>
